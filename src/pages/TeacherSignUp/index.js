...
class TeacherSignUp extends Component {
  ...
  handleSubmit = async (e) => {
    ...
    data.append('documentNumber', this.state.documentNumber)
    ...
    data.append('addressDetails', this.state.addressDetails)
    data.append('neighborhood', this.state.neighborhood)
    data.append('foneMobile', this.state.foneMobile)
    data.append('foneHome', this.state.foneHome)
    data.append('foneCompany', this.state.foneCompany)
    ...
    .then(res => {
        ...
        console.log(data);
        this.props.history.push("/auth/loginTeacher");
      })
      .catch(error => {
      ...
      <div className="scrollBar">
        ...
        <main className="content">
          ...
          <div className="mb-2 mt-1">
            <form encType="multipart/form-data" method="POST" id="formRegister" onSubmit={this.handleSubmit}>
              <fieldset>
                  ...
                  <div className="block p-3">
                    ...
                    <div className="form-row">
                      ...
                      <div className="form-group col-12 col-md-5">
                        <label htmlFor="file" className="required">Diploma</label>
                        <input type="file" className="form-control-file" id="file" name="file" onChange={this.handleFileChange} maxLength={45} required />
                      </div>
                    </div>
                  </div>
